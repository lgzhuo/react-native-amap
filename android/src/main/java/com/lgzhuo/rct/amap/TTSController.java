...
/**
 * Created by lgzhuo on 2017/6/27.
 */

class TTSController implements AMapNaviListener {
    ...
    private InitListener mTtsInitListener = new InitListener() {
        ...
        public void onInit(int code) {
            ...
            if (code != ErrorCode.SUCCESS) {
                Log.w("TTSController", "TTS初始化失败,错误码：" + code);
            }
        }
    };
    ...
    private TTSController(Context context) {
        ...
        try {
            ...
            appid = ai.metaData.getString("com.iflytek.apikey");
    ...
    static TTSController getInstance(Context context) {
        if (ttsManager == null) {
    ...
    static void destroy() {
        if (ttsManager != null) {
            if (ttsManager.mTts != null) {
                ttsManager.mTts.stopSpeaking();
                ttsManager.mTts.destroy();
            }
            ttsManager = null;
        }
    }
